...
function displayPreview(input) {
  ...
  $('#preview-container').show();
    ...
    if (input.files && input.files[0]) {
      ...
      reader.onload = function (e) {
          ...
          $('#post-attatchment-preview').attr('src', e.target.result);
      }
    }
  }
  ...
  $("#post-attatchment-file").change(function(){
...
$('#emoji-attatchment-container').click(function(){

  if($('#emoji-picker').attr('display') == 'hidden') {
    $('#emoji-picker').attr('display', 'visible');
    $('#emoji-picker').show();
  }

  else if($('#emoji-picker').attr('display') == 'visible') {
    $('#emoji-picker').attr('display', 'hidden');
    $('#emoji-picker').hide();
  }
